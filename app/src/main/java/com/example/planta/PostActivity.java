        ...
        if (imageUri != null){
            ...
            uploadtask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if (!hashTags.isEmpty()){
                        for (String tag : hashTags){
                            map.clear();
                            //make it easier for users to search the hashtags
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(PostActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show(); //e.get messages tells us exactly what went wrong
                }
            });
        } else {
